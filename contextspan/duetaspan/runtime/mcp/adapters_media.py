...
SGD's Music_3 catalog holds 594 seeded tracks, none of them Korean, so a request for a Korean
artist's songs could only ever return nothing. iTunes Search needs no key and knows the
