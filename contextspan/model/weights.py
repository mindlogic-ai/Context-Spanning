...
def load_voice(name_or_path="main"):
    """Voice prompt = agent-voice Mimi codes [8, P] saved as {'codes': LongTensor}. A bare name
    (main, f0-f3, m0-m3, or any file under the repo's voices/) is fetched as voices/<name>.pt.
    ...
    that were current when it was uploaded, so honouring it here would make "main" a different
