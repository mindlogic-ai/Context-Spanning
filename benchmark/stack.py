...
CTX = {"city": "Seoul", "timezone": "Asia/Seoul"}      # the profile used for the released results
...
class Stack:
    ...
    voice block is outside the training distribution, and the released results drew the voice from the
